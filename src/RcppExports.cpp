...
// sim_locustree_bdp
Rcpp::List sim_locustree_bdp(SEXP species_tree_, SEXP gbr_, SEXP gdr_, SEXP lgtr_, SEXP numLoci_);
RcppExport SEXP _treeducken_sim_locustree_bdp(SEXP species_tree_SEXP, SEXP gbr_SEXP, SEXP gdr_SEXP, SEXP lgtr_SEXP, SEXP numLoci_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< SEXP >::type numLoci_(numLoci_SEXP);
    rcpp_result_gen = Rcpp::wrap(sim_locustree_bdp(species_tree_, gbr_, gdr_, lgtr_, numLoci_));
    return rcpp_result_gen;
END_RCPP
}
