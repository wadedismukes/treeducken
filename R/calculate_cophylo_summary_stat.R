...
#'
#' @description For cophylogenetic objects produced in treeducken via `sim_cophyloBD`, calculates the numbers of different events of interest. In addition, calculates and tests the ParaFit test.
#'
#' @param cophy_obj The cophylogenetic object produced via `sim_cophyloBD`
...
#' cosp_rate <- 2.0
#'
#' cophy_pair <- sim_cophyloBD(hbr = host_lambda,
#'                            hdr = host_mu,
#'                            cosp_rate = cosp_rate,
