...
```{r}
host_tree_locus_trees <- sim_locustree_bdp(host_tree, gbr = 0.4, gdr = 0.2, lgtr = 0.0, num_loci = 100)
plot(host_tree)
# str(host_tree_locus_trees)
...
treeducken::plot.cophylo(gopher_lice_cophylo)
```
