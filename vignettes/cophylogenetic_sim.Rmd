...
```{r}
host_tree_locus_trees <- sim_locustree_bdp(host_tree, gbr = 0.4, gdr = 0.2, lgtr = 0.0, num_loci = 10)
plot(host_tree)
...
```{r}
loctr_genetr_set <- sim_locustree_genetree_msc(symb_tree,
                                               gbr = 0.2,
                                               gdr = 0.1,
                                               lgtr = 0.1,
                                               num_loci = 10,
...
treeducken::plot.cophy(gopher_lice_cophylo)
```
